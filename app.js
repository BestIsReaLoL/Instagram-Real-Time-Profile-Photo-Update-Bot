...
//Piyasada ilklerdendir
  ...
  await page.type('input[name="username"]', 'bestisrealol'); //'KULLANICI_ADINIZ '  KULLANICI_ADINIZ yazan kısma yani tırnakları silmeden tırnakların içerisine kullanıcı adınızı yazınız
  // console.log("Kullanıcı adı textbox'ına kullanıcı adınız yazılıyor");
  await page.type('input[name="password"]', 'rdmsnr'); // Aynı şekilde SIFRENIZ kısmına da o şekilde boşluk bırakmayın
